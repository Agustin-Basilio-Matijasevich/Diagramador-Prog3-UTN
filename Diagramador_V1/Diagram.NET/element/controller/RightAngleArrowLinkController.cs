...
namespace Dalssoft.DiagramNet
{
	...
	/// </summary>
	internal class RightAngleArrowLinkController: IController, IMoveController, IResizeController, ILabelController
	{
		//parent element
		protected RightAngleArrowLinkElement el;
		...
		public RightAngleArrowLinkController(RightAngleArrowLinkElement element)
		{
			el = element;
