...
namespace Dalssoft.DiagramNet
{
	...
	/// </summary>
	internal class RightAngleDoubleArrowLinkController: IController, IMoveController, IResizeController, ILabelController
	{
		//parent element
		protected RightAngleDoubleArrowLinkElement el;
		...
		public RightAngleDoubleArrowLinkController(RightAngleDoubleArrowLinkElement element)
		{
			el = element;
