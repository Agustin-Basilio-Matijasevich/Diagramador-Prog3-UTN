...
{
	[Serializable]
	public class RightAngleArrowLinkElement: BaseLinkElement, IControllable, ILabelElement
	{
		...
		[NonSerialized]
		private RightAngleArrowLinkController controller;

		public RightAngleArrowLinkElement(ConnectorElement conn1, ConnectorElement conn2): base(conn1, conn2)
		{
			needCalcLink = true;
		...
		{
			if (controller == null)
				controller = new RightAngleArrowLinkController(this);
			return controller;
		}
